...
const termToEnding = (rawTerm) => {
  if (rawTerm === '2021 Fall') {
    return 'F20219';
  } else if (rawTerm === '2021 Fall +') {
    return 'Y20219';
  } else if (rawTerm === '2022 Winter') {
    return 'S20221';
  }
};
  ...
  await cluster.task(async ({ page, data }) => {
    ...
    let rawCourseData = await page.evaluate(() => {
      ...
      let rawCourseInfo = {
        ...
        rawPrerequisites: document.querySelector("span[id='u50']")
          ? document.querySelector("span[id='u50']").innerText
          : '',
        rawCorequisites: document.querySelector("span[id='u59']")
          ? document.querySelector("span[id='u59']").innerText
          : '',
        rawExclusions: document.querySelector("span[id='u68']")
          ? document.querySelector("span[id='u68']").innerText
          : '',
      ...
      if (campusNumber === '1') {
        rawCourseInfo.rawDistribution = document.querySelector("span[id='u131']")
          ? document.querySelector("span[id='u131']").innerText
          : '';
        rawCourseInfo.rawBreadth = document.querySelector("span[id='u122']")
          ? document.querySelector("span[id='u122']").innerText
          : '';
      } else if (campusNumber === '3') {
        rawCourseInfo.rawBreadth = document.querySelector("span[id='u104']")
          ? document.querySelector("span[id='u104']").innerText
          : '';
      } else if (campusNumber === '5') {
        rawCourseInfo.rawDistribution = document.querySelector("span[id='u113']")
          ? document.querySelector("span[id='u113']").innerText
          : '';
      }
